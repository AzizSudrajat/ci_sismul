...
<body>
	...
	<div class="tabel">
			<form method="post" action="<?php echo base_url();?>admin/welcome/tambahgambar">
        		<div>
				<br>
            	<input type="submit" class="btn btn-primary" value="Tambah gambar"/>
        		</div>
    		</form>
	...
	<table border="1" class="table table-striped table-bordered table-hover" id="dataTables-example">
      <thead><tr>
        ...
        <?php $no=1; foreach($record->result_array() as $list){?>
          <tr>
            <td><?php echo $no;?></td>
            <td><?php echo $list['nama_gambar'];?></td>
            <td><?php echo $list['deskripsi_gambar'];?></td>
            <td><?php echo $list['gambar'];?></td>
            <td><a href="<?php echo base_url();?>admin/welcome/editgambar/<?php echo $list['id'];?>"class="btn btn-sm btn-default"><span class="glyphicon glyphicon-wrench"></span></a>
              <a href="<?php echo base_url();?>admin/welcome/do_hapus_gambar/<?php echo $list['id'];?>" onClick="return checkMe()" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        <?php $no++ ; } }?>
</tr>
