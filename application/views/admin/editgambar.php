    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class ="container-fluid">
          ...
          <?php echo form_open_multipart('admin/welcome/update_gambar'); ?>
          <?php foreach ($record as $list) { ?>
            <table class="table table-bordered table-hover table-striped">
              <input type="hidden" name="id" placeholder="id" value="<?php echo $list->id;?>">
              <tr>
                <th>Nama Gambar</th>
                <td><input type="text" name="nama_gambar" placeholder="Nama Gambar" class="form-control" value="<?php echo $list->nama_gambar; ?>" required></td>
              </tr>
              <tr>
                <th>Deskripsi Gambar</th>
                <td>
                  <textarea class=" ckeditor" placeholder="Deskripsi" name="deskripsi_gambar" required><?php echo $list->deskripsi_gambar; ?></textarea>
                </td>
              </tr>
              <tr>
                <th>Gambar Lama</th>
                  <input type="hidden" name="gambar" class="form-control" id="gambar" value="<?php echo $list->gambar; ?>">
                <td><img style="height: 400px; width: 500px" class="img-responsive" src="<?php echo base_url();?>uploads/gallery/<?php echo $list->gambar;?>" alt=""></td>
              </tr>
              <tr>
                <th>Gambar Baru</th>
                <td>
