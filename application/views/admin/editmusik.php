  ...
  <!-- Navigation -->
    ...
    <div id="page-wrapper">
      <div class ="container-fluid">
        ...
        <?php echo form_open_multipart('admin/welcome/update_musik'); ?>
        <?php foreach ($record as $list) { ?>
          ...
          <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
              <th>Nama musik</th>
              <td><input type="text" name="nama_musik" placeholder="Nama musik" class="form-control" value="<?php echo $list->nama_musik; ?>" required></td>
            </tr>
            <tr>
              <th>Penyanyi</th>
              <td><input type="text" name="penyanyi" placeholder="Penyanyi" class="form-control" value="<?php echo $list->penyanyi; ?>" required></td>
            </tr>
            <tr>
              <th>musik Lama</th>
              <input type="hidden" name="musik" class="form-control" id="musik" value="<?php echo $list->musik; ?>">
              <td> <audio controls> <source src="<?php echo base_url();?>uploads/musik/<?php echo $list->musik;?>" type="audio/mp3" alt=""/> </audio></td>
            </tr>
            <tr>
              <th>musik Baru</th>
              <td>
