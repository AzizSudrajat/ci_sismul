...
<body>
    ...
    <?php echo form_open_multipart('admin/welcome/insert_video'); ?>
    <table class="table table-bordered table-hover table-striped">
        <tr>
            <th>Nama video</th>
            <td><input type="text" name="nama_video" placeholder="Nama video" class="form-control" required></td>
        </tr>
         <tr>
            <th>Deskripsi video</th>
            <td>
                <textarea class="ckeditor" placeholder="Deskripsi video" name="deskripsi_video" required> </textarea>
            </td>
        </tr>
        <tr>
            <th>video</th>
