...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                   <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/welcome/video"><i class="fa fa-table fa-fw"></i> Lihat video</a>
                        </li>
                        <li>
    ...
    <?php echo form_open_multipart('admin/welcome/update_video'); ?>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tr>
            <th>Nama video</th>
            <td><input type="text" name="nama_video" placeholder="Nama video" class="form-control" value="<?php echo $list->nama_video; ?>" required></td>
        </tr>
        <tr>
            <th>Deskripsi video</th>
            <td>
                <textarea class=" ckeditor" placeholder="Deskripsi" name="deskripsi_video" required><?php echo $list->deskripsi_video; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>video Lama</th>
            <input type="hidden" name="video" class="form-control" id="video" value="<?php echo $list->video; ?>">
            <td> <video width="550" controls> <source src="<?php echo base_url();?>uploads/videos/<?php echo $list->video;?>" type="video/mp4" alt=""/> </video></td>
        </tr>
        <tr>
            <th>video Baru</th>
            <td>
