...
<body>
    ...
    <?php echo form_open_multipart('admin/welcome/insert_gambar'); ?>
    <table class="table table-bordered table-hover table-striped">
        <tr>
            <th>Nama gambar</th>
            <td><input type="text" name="nama_gambar" placeholder="Nama Gambar" class="form-control" required></td>
        </tr>
         <tr>
            <th>Deskripsi Gambar</th>
            <td>
                <textarea class="ckeditor" placeholder="Deskripsi Gambar" name="deskripsi_gambar" required> </textarea>
            </td>
        </tr>
        <tr>
            <th>Gambar</th>
